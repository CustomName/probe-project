...
class ProcessStatusServiceTest extends BaseServiceTest {
    ...
    void getAllProcessStatuses() {
        final ProcessStatus processStatus1 = ProcessStatus.builder()
                .idProcessStatus(UUID.randomUUID())
                .name("NEW")
                .description("Новый процесс")
                .build();

        final ProcessStatus processStatus2 = ProcessStatus.builder()
                .idProcessStatus(UUID.randomUUID())
                .name("COMPLIANCE_SUCCESS")
                .description("Комплаенс проверка успешно выполнена")
                .build();

        final ProcessStatusResponse processStatusResp1 = new ProcessStatusResponse()
        ...
        final ProcessStatusResponse processStatusResp2 = new ProcessStatusResponse()
        ...
        final List<ProcessStatus> processStatuses = List.of(processStatus1, processStatus2);
        final List<ProcessStatusResponse> processStatusResponses = List.of(processStatusResp1, processStatusResp2);
        ...
        final List<ProcessStatusResponse> allProcessStatuses = processStatusService.getAllProcessStatuses();
